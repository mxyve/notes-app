...
const rili = ({ onDateSelect }) => {
  ...
  const onDateChange = (value, selectInfo) => {
    if (selectInfo.source === 'date') {
      setSelectDate(value);
      console.log('选中的日期是:', value.format('YYYY-MM-DD'));
      if (onDateSelect) {
        onDateSelect(value);
      }
    }
  ...
  const cellRender = (date, info) => {
    ...
    const displayHoliday =
      (h === null || h === void 0 ? void 0 : h.getTarget()) ===
      (h === null || h === void 0 ? void 0 : h.getDay())
        ? h === null || h === void 0
          ? void 0
          : h.getName()
        : undefined;
    if (info.type === 'date') {
      return React.cloneElement(
        info.originNode,
        Object.assign(Object.assign({}, info.originNode.props), {
